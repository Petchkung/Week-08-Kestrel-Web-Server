...
2. ทำไมเราจึงต้องกดปุ่ม `Ctrl + ]` เพื่อปิด **ESP-IDF Monitor** ก่อนที่เราจะรันโปรแกรมฝั่ง C# Kestrel ในใบงานถัดไป
   *(คำใบ้: หากโปรเซส idf.py monitor ยังเปิดค้างอยู่ จะเกิดอะไรขึ้นกับพอร์ต COM)*
   - **คำตอบ:** เพื่อปลดล็อกและคืนสิทธิ์การใช้งานพอร์ตสื่อสารอนุกรม (COM Port) เนื่องจากพอร์ต COM สามารถถูกเปิดใช้งานได้ทีละ 1 โปรเซสเท่านั้น หากไม่กด Ctrl + ] เพื่อปิด Monitor ตัวโปรแกรมฝั่ง C# Kestrel ในใบงานถัดไปจะไม่สามารถเปิดเชื่อมต่อกับพอร์ต COM เดียวกันได้
---
...
<img width="1496" height="990" alt="image" src="https://github.com/user-attachments/assets/8b8fb96a-087b-4585-95df-5209482ef05d" />
<img width="1108" height="1477" alt="image" src="https://github.com/user-attachments/assets/ff7acb5d-93b4-4ccf-ab21-7222cb852160" />
